...
@endsession
<form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('students/'.$student->id.'/update')}}">
    @csrf
    <div class="row gx-4">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <input value="{{$student->first_name}}" type="text" class="form-control" id="first_name" name="first_name"
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <input value="{{$student->middle_name}}" type="text" class="form-control" id="middle_name" name="middle_name"
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <input value="{{$student->home_region}}" type="text" class="form-control" id="home_region" name="home_region"
                ...
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <select class="form-select" id="abc4" name="education_level" required
                            aria-label="Default select example">
                            <!-- <option selected="">select gender</option> -->
                            <option <?php if($student->education_level == "Form Four"){?> selected<?php } ?> value="Form Four">Form Four</option>
                            <option <?php if($student->education_level == "Form Six"){?> selected<?php } ?> value="Form Six">Form Six</option>
                            <option <?php if($student->education_level == "Certificate"){?> selected<?php } ?> value="Certificate">Certificate</option>
                            <option <?php if($student->education_level == "Diploma"){?> selected<?php } ?> value="Diploma">Diploma</option>
                            <option <?php if($student->education_level == "Degree"){?> selected<?php } ?> value="Degree">Degree</option>
                ...
                <div class="card-body">
                    <div class="m-0">
                        ...
                        <div class="input-group">
                            <input value="{{$student->dob}}" type="date" id="abc3" required name="dob" class="form-control datepicker" />
                        </div>
