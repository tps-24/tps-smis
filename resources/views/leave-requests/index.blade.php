...
<div class="col-sm-12">
    ...
    <div class="card mb-3">
        <div class="card-body">
        <form action="{{ route('leave-requests.index') }}" method="GET" class="d-flex justify-content-between mb-3">
    <div class="d-flex">
...
<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#studentModal{{ $student->id }}">
    Enter Student Leave Details
</button>

<!-- Modal -->
<div class="modal fade" id="studentModal{{ $student->id }}" tabindex="-1" aria-labelledby="modalLabel{{ $student->id }}" aria-hidden="true">
              ...
              <form action="{{ route('leave-requests.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel{{ $student->id }}">
                        Enter Leave Details for {{ $student->first_name }} {{ $student->last_name }}
                    </h5>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                        ...
                        <textarea class="form-control rounded-3" id="reason" name="reason" rows="3" placeholder="Explain the reason for your leave" required></textarea>
                    </div>

                    <!-- Phone Number -->
                    <div class="col-md-6">
                        <label for="phone_number" class="form-label">📞 Phone Number</label>
                        <input type="text" class="form-control rounded-3" id="phone_number" name="phone_number" placeholder="Enter student phone number" >
                    </div>

                    <!-- Location -->
                    <div class="col-md-6">
                        <label for="location" class="form-label">📍 Location</label>
                        <input type="text" class="form-control rounded-3" id="location" name="location" placeholder="Enter leave location" required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="file" class="form-control rounded-3" id="attachments" name="attachments">
                    </div>
