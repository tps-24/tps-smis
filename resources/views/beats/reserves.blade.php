                    ...
                    <tbody>
                        @foreach ($reserves as $reserve)
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('beats.approve-reserves', ['type'=>"approve", 'studentId' =>$reserve->student_id]) }}">Approve</a>
                                <a class="btn btn-primary btn-sm" href="{{ route('beats.approve-reserves', ['type'=>"disapprove", 'studentId' =>$reserve->student_id]) }}">Disaprove</a>
                                </td>
                                @endif
                            </tr>
                        @endforeach
