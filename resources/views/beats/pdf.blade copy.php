            ...
            <tbody>
                @foreach($company->guardAreas as $area)
                    <tr>
                        ...
                        @foreach($timeSlots as $slot)
                            @php
                                $beat = $area->beats->firstWhere('start_at', '=', explode(' - ', $slot)[0]);
                                $studentNames = '';
                                $platoonNumbers = '';
                                if ($beat) {
                                    ...
                                    foreach ($students as $student) {
                                        $studentNames .= $student->first_name . ' ' . $student->last_name . ' (Gender: ' . $student->gender . '), ';
                                        $platoonNumbers .= 'PLT ' . $student->platoon . ', ';
                                    }
