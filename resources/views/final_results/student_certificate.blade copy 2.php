                ...
                <div class="tab-pane fade @if($loop->first) show active @endif" id="company-{{ $company->id }}" role="tabpanel" aria-labelledby="tab-{{ $company->id }}">
                    <div class="card my-3">
                        <div class="card-header">
                            <i>Choose student to print certificate</i>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('certificates.generateCertificate', $student->id) }}" method="GET" class="form-inline mb-4">
                                <input type="hidden" name="date" value="{{ $date ?? \Carbon\Carbon::today()->toDateString() }}">
                                <button type="submit" class="btn btn-secondary" style="float:right">Print Certificate</button>
                            </form>
                                            </td>
                                        </tr>
                                        @endforeach
