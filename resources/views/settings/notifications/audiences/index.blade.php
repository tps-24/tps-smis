  ...
  <div class="col-sm-12">
    <div class="card mb-3">
      ...
      <div class="pull-right" >
          <a class="btn btn-success mb-2" href="{{ route('notifications.audiences.create') }}" style="float:right !important; margin-right:1%"><i class="fa fa-plus"></i> Create New Campus</a>
      </div>
      <div class="card-body">
