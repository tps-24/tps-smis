    ...
    <div class="col-sm-12 col-12">
        <div class="card mb-4">
            <div class="card-header">
                ...
                <div class="pull-right" >
                    <a class="btn btn-success mb-2" href="{{ route('course.coursework.create',['courseId'=>$course->id]) }}" style="float:right !important;"><i class="fa fa-plus"></i> Add Assessment Type</a>
                </div>
            </div>
            <div class="card-body">
