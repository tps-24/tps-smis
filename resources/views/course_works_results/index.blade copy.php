    ...
    <div class="card mb-3">
      <div class="card-header">
          ...
          <div class="pull-right" >
              ...
              <a class="btn btn-success mb-2" href="{{ route('coursework_results.create') }}" style="float:right !important; margin-right:1%"><i class="fa fa-plus"></i> Create New course</a>
          </div>
      </div>
      <div class="card-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchCourseworkResults(courseId) {
        ...
        fetch(`${basePath}/coursework_results/course/${courseId}`)
            .then(response => {
