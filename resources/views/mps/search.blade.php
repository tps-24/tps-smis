                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#statusModal{{ $patient->id ?? ''}}">
                                        Enter Student Details
                                    </button>
                                    <div class="modal fade" id="statusModal{{  $patient->id ?? '' }}" tabindex="-1"
                                        aria-labelledby="statusModalLabel{{  $patient->id ?? '' }}" aria-hidden="true">
