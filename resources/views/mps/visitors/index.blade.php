                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="statusModalLabel{{  $student->id ?? ''}}">
                                                            Visitor Details for {{ $visitor->student->first_name }} {{ $visitor->student->last_name }}
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{url('/visitors/update/' . $visitor->id)}}" method="POST">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" value="{{ $visitor->names }}"   type="text" required
                                                                    name="visitor_name">
                                                            </div>
                                                            @error('visitor_name')
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" value="{{ $visitor->phone }}"   type="text" required
                                                                    name="visitor_phone">
                                                            </div>
                                                            @error('visitor_phone')
                                                                <div class="error">{{ $message }}</div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" value="{{ $visitor->relationship }}"  type="text" required
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" value="{{ $visitor->visited_at }}" type="datetime-local" required
                                                                    name="visited_at">
                                                            </div>
                                                            @error('visited_at')
                                                                <div class="error">{{ $message }}</div>
