  ...
  <div class="col-sm-12">
    <div class="card mb-3">
      ...
      <div class="pull-right" >
          <a class="btn btn-success mb-2" href="{{ route('staffs.create') }}" style="float:right !important; margin-right:1%"><i class="fa fa-plus"></i> Create New Staff</a>
      </div>
      <div class="card-body">
            ...
            <table class="table table-striped truncate m-0">
              ...
              @foreach ($staffs as $key => $staff)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-sm" href="{{ route('staffs.show',$staff->id) }}"><i class="fa-solid fa-list"></i> Show</a>
                        <a class="btn btn-primary btn-sm" href="{{ route('staffs.edit',$staff->id) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
