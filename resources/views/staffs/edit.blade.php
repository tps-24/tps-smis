                                        ...
                                        <div class="row" style="margin-bottom:-1%">
                                            <div class="col-sm-3 col-12" id="pfn0" style="margin-left:12.5%;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="forceNumber" name="forceNumber" placeholder="Enter PF Number/Force Number"  value="{{ $staff->forceNumber }}" required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>                                            
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="nin" name="nin" placeholder="Enter NIDA Number" value="{{ $staff->nin }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-bottom:-1%">
                                            <div class="col-sm-3 col-12" style="margin-bottom:-1%">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Enter First Name" value="{{ $staff->firstName }}" required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12" style="margin-bottom:-1%">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="middleName"  name="middleName" placeholder="Enter Middle Name"  value="{{ $staff->middleName }}"required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12" style="margin-bottom:-1%">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="lastName"  name="lastName" placeholder="Enter Last Name"  value="{{ $staff->lastName }}"required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="religion"  name="religion" placeholder="Enter religion" value="{{ $staff->religion }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="tribe" name="tribe" placeholder="Enter tribe" value="{{ $staff->tribe }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3 col-12" style="margin-top:-1%">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter email address" value="{{ $staff->email }}" required>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12" style="margin-top:-1%">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="currentAddress" name="currentAddress" placeholder="Enter current address" value="{{ $staff->currentAddress }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12" style="margin-top:-1%">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="permanentAddress" name="permanentAddress" placeholder="Enter permanent address" value="{{ $staff->permanentAddress }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-bottom:-1%">                                   
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="designation" name="designation" placeholder="Enter designation" value="{{ $staff->designation }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>                                  
                                        ...
                                        <div class="row">                                                                                        
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="date" class="form-control" id="joiningDate" name="joiningDate" value="{{ $staff->joiningDate }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="text" class="form-control" id="location" name="location" placeholder="Enter Location" value="{{ $staff->location }}">
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
