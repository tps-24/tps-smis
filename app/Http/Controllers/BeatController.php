...
class BeatController extends Controller
{
    ...
    public function edit($beat_id)
    {
        ...
        $eligible_students = Student::where('company_id', 2)->whereIn('platoon', [8,9,10,11,12,13,14])->where('beat_round','<', 10)->where('beat_status', 1)->where('gender', "F")->get();
    ...
    function generateBeats($areas, $studentsByCompany, $studentsByPlatoon, $beatType, $date, &$usedStudentIds)
    {
        ...
        foreach ($areas as $areaData) {
            ...
            if ($numPlatoons > 0 && $requiredStudents > 0) {
                ...
                Student::whereIn('id', $assignedStudentIds)->update(['beat_status' => 13]);
            }
