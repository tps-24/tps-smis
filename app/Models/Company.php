...
class Company extends Model
{
    ...
    public function company_attendance($date, $attendanceTypeId)
    {
        return $this->hasMany(CompanyAttendance::class, 'company_id', 'id')->where('attendenceType_id', $attendanceTypeId)->whereDate('date', \Carbon\Carbon::parse($date)->format('Y-m-d'))->first();
    }
}
